...
<head>
    ...
    <!-- CSS para el Header con versión dinámico (evita caché) -->
    <link rel="stylesheet" href="<?= base_url('activos/css/espectaculo_logueado/header_espectaculo_logueado.css?v=' . time()); ?>">
...
<header class="main-header">
    <div class="header-container">
        ...
        <!-- Logo + título -->
        <a href="<?= base_url(); ?>" class="brand" title="Inicio">
        ...
        <!-- Menú de navegación -->
        <nav class="nav-menu">
            <!-- Botón azul "Ir al Usuario" -->
            <a href="<?= base_url('usuario'); ?>" class="btn btn-volver">Ir al Usuario</a>
