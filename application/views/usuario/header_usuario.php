...
<header class="main-header">
    <div class="header-container">
        ...
        <!-- Menú de navegación -->
        <nav class="nav-menu">
            <!-- Botón que activa el Modal para Confirmar Cierre de Sesión -->
            <a href="#" class="btn btn-register" data-bs-toggle="modal" data-bs-target="#confirmModal">Cerrar Sesión</a>
        </nav>
    </div>
</header>
...
<!-- Scripts de Bootstrap para Modal -->
